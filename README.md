...
* 🔧 I build **end-to-end systems** combining hardware + software + data
* 💡 Strong interest in **IoT, backend development, and applied ML**
* 📈 Focused on writing **clean code, practical solutions, and scalable systems**
* 🎯 Actively looking for **internship opportunities in Software / IoT / Cloud**
